...
const TopicHelper: React.FC<TopicHelperProps> = ({ 
  ...
  return (
    <div className={`w-full transition-all duration-700 ${disabled ? 'opacity-40 grayscale blur-[1px]' : 'opacity-100'}`}>
      <div className="flex items-center justify-between mb-4 px-1">
        ...
        <div className="flex items-center gap-2">
          ...
          {!disabled && onManualRefresh && (
            <button onClick={onManualRefresh} className="p-1 text-[#8BA888] hover:text-[#6B8E6B] transition-colors">
      ...
      <div className="flex flex-col gap-3 max-h-[450px] overflow-y-auto pr-2 no-scrollbar">
